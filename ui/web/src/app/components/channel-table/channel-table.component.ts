...
export class ChannelTableComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.channels$ = this.channelsSubject
            ...
            .switchMap(() => this.smartraidenService.getChannels())
            ...
            .do(() => timeout = setTimeout(() => this.channelsSubject.next(null),
                this.smartraidenConfig.config.poll_interval));
    }
    ...
    public manageChannel() {
        ...
        switch (this.action) {
            case 'transfer':
                ...
                this.smartraidenService.initiateTransfer(
                ...
                break;
            case 'deposit':
                this.smartraidenService.depositToChannel(
                ...
                break;
            case 'close':
                this.smartraidenService.closeChannel(this.tempChannel.channel_address)
                    .finally(() => this.channelsSubject.next(null))
                    .subscribe((response) => this.showMessage(response));
                break;
            case 'settle':
                this.smartraidenService.settleChannel(this.tempChannel.channel_address)
                    .finally(() => this.channelsSubject.next(null))
                    .subscribe((response) => {
