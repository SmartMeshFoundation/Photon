 ...
 */
   ...
   */
    ...
    function setTotalDeposit(uint256 channel_identifier ,address participant, uint256 total_deposit)
    ...
    public
    {
        ...
        require(withdrawnonce == channel.withdrawnonce + 1);
        ...
        channel.withdrawnonce = withdrawnonce;
        //The sum of the provided deposit must be equal to the total available deposit
        withdrawnonce = participant1_state.deposit + participant2_state.deposit;
        require(participant1_deposit <= withdrawnonce);
        require(participant2_deposit <= withdrawnonce);
        require((participant1_deposit + participant2_deposit) == withdrawnonce);
    ...
    */
    ...
    public
    {
        ...
        Channel storage channel = channels[channel_identifier];
        require(channel.withdrawnonce == withdrawnonce);
        ...
        if (nonce > 0) {
            ...
            require(channel.participants[recovered_partner_address].initialized);
        }
    ...
    */
    ...
    public
    {
        ...
        Channel storage channel = channels[channel_identifier];
        require(channel.withdrawnonce == withdrawnonce);
        closing_participant = channel.closing_participant;
    ...
    */
    ...
    public
    {
        ...
        key = keccak256(abi.encodePacked(participant_state.nonce, computed_locksroot));
        require(!participant_state.unlocked_locks[key]);
        participant_state.unlocked_locks[key] = true;
        ...
        participant_state.transferred_amount += unlocked_amount;
        emit ChannelUnlocked(channel_identifier, participant,computed_locksroot, participant_state.transferred_amount);
    }
    /*
    ...
    public
    {
        ...
        */
        locksrootxxx=computeMerkleRoot(lockhash,merkle_proof);
        require(beneficiary_state.locksroot==locksrootxxx);
        /*
        punish the cheater.
        */
    ...
    */
    ...
    public
    {
        ...
        if (
            (participant1_state.deposit + participant2_state.transferred_amount) < participant1_state.transferred_amount
        ) {
    ...
    */
    ...
    view
    external
    returns (uint256,uint256, uint256, address, uint8)
    {
    ...
    view
    external
    returns (bool, uint256, bytes32, uint256, uint256)
    {
