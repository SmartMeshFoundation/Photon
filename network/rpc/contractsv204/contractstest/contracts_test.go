...
import (
	...
	"github.com/SmartMeshFoundation/SmartRaiden/network/rpc/contractsv204/contracts"
...
func setup() {
	...
	tokenNetworkAddress = common.HexToAddress("0x0e7daa387d4e6bf2a1872f10490582664dde0e67")
...
func TestUnlock(t *testing.T) {
	...
	tx, err = tokenNetwork.Unlock(auth, auth.From, partnerAddr, bp2.TransferAmount, bp2.LocksRoot, lockbytes)
	if err != nil {
		t.Error(err)
		return
	}
