...
import (
	...
	"github.com/SmartMeshFoundation/SmartRaiden/network/rpc/contractsv201/contracts"
...
func setup() {
	...
	tokenNetworkAddress = common.HexToAddress("0x7cb6ae533b7f4365300f850f4d40281aa0659ef7")
...
func TestPunishObsoleteUnlock(t *testing.T) {
	...
	log.Info(fmt.Sprintf("unlockarg,channelid=%s,partnerAddr=%s,part2=%s,proof=%s", common.Hash(channelID).String(), partnerAddr.String(),
