   ...
   */
    ...
    */
    ...
    public
    {
        ...
        emit Channelwithdraw(channel_identifier, participant1_balance, participant2_balance, participant1_withdraw, participant2_withdraw);
    ...
    */
    ...
    public
    {
        ...
        participant_state.balance_hash=calceBalanceHash(transferred_amount,locksroot);
        participant_state.nonce=nonce;
        emit BalanceProofUpdated(channel_identifier, participant,locksroot,transferred_amount);
    }
    /*
   ...
   */
    ...
    */
    ...
    public
    {
        ...
        locksroot_hash=keccak256(balance_hash,channel_identifier,participant_state.nonce);
        ...
        require(balance_hash==calceBalanceHash(transferered_amount,locksroot));
        /*
        会不会溢出呢? 两人持续交易?
        正常来说,不会,
        ...
        */
        participant_state.balance_hash=calceBalanceHash(transferered_amount,locksroot);
        emit ChannelUnlocked(channel_identifier, participant,computed_locksroot, transferered_amount);
    }
    /*
    ...
    */
    ...
    public
    {
        ...
        */
        ...
        require(balance_hash==calceBalanceHash(beneficiary_transferred_amount,locksroot));
        /*
        punish the cheater.
        */
