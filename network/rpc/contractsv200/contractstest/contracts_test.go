...
import (
	...
	"github.com/SmartMeshFoundation/SmartRaiden/network/rpc/contractsv200/contracts"
...
func setup() {
	...
	tokenNetworkAddress = common.HexToAddress("0x3cc385a931f098cbc7686977a119ec86996e76e5")
...
func TestCloseChannelAndUpdateNonClosingAndSettle(t *testing.T) {
	...
	tx, err = tokenNetwork.UpdateBalanceProof(auth, auth.From, partnerAddr, bp2.TransferAmount, bp2.LocksRoot, bp2.Nonce, utils.BigInt0, utils.EmptyHash, utils.BigInt0, bp2.AdditionalHash, bp2.Signature, bp2.NonClosingSignature)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestPunishObsoleteUnlock(t *testing.T) {
	...
	tx, err = tokenNetwork.PunishObsoleteUnlock(auth, auth.From, partnerAddr, lockhash, bp2.TransferAmount, bp2.Nonce, ou.AdditionalHash,
