...
func TestMobile(t *testing.T) {
	...
	api, err := StartUp(nodeAddr.String(), "../testdata/keystore", rpc.TestRPCEndpoint, path.Join(os.TempDir(), utils.RandomString(10)), "../testdata/keystore/pass", "0.0.0.0:5001", "127.0.0.1:40001", "", params.RegistryAddress.String(), nil)
	if err != nil {
		t.Error(err)
		return
	}
