...
*/
func (this *Api) Transfers(tokenAddress, targetAddress string, amountstr string, feestr string, id int64) (transfer string, err error) {
	tokenAddr := common.HexToAddress(tokenAddress)
	...
	err = this.api.Transfer(tokenAddr, amount, fee, targetAddr, identifier, params.MaxRequestTimeout)
	if err != nil {
		return
	}
	req := &transferData{}
